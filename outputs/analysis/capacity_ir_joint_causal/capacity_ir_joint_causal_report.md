...
- `bin05` 的 `support_width_1_99=0.000106`，属于支持域极窄区间；其“+1pp”效应应与支持宽度归一口径一起解读，避免外推放大误读。
- 双口径对比显示：容量 raw 头部为 `bin05（SOC [0,10) / 倍率 [0,0.434) / 温度 [36,60]）`，支持宽度归一头部为 `bin38（SOC [10,90) / 倍率 [4.22,7.75] / 温度 [32,34)）`；阻抗 raw 头部为 `bin05（SOC [0,10) / 倍率 [0,0.434) / 温度 [36,60]）`，支持宽度归一头部为 `bin05（SOC [0,10) / 倍率 [0,0.434) / 温度 [36,60]）`。
- 高温风险分层判定：容量 `partial`，阻抗 `partial`；当前证据更支持“低SOC层高温风险更强”，而非“全SOC单调升温即更高风险”。
...
- `bin05` 在 raw 口径下斜率很高，但其支持区间仅 `0.000106`，属于稀有高温状态驱动的高斜率区间，不应直接解读为“低倍率本身高风险”。
- Top5 排名重叠度：容量 `0/5`，阻抗 `1/5`。结论：raw 与归一口径偏离显著，建议双口径并行陈述主结论。
- 是否需要刷新报告：`是`（依据：raw/norm 排名重叠度、支持宽度差异、SOC×温度分层一致性）。
### 8.1 raw 与支持宽度归一排名对比（容量）
| rank_raw | rank_norm | rank_delta | cross_bin | cross_label | condition_text | effect_per_1pp | effect_support_norm | support_width_1_99 | q_value | risk_category |
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | 7 | 6 | 5 | s1_r1_t5 | SOC [0,10) / 倍率 [0,0.434) / 温度 [36,60] | 1.246480 | 0.013258 | 0.000106 | 0.055000 | dual_risk |
| 2 | 24 | 22 | 51 | s3_r3_t1 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [20,31) | 0.140462 | 0.000000 | 0.000000 | 0.325000 | uncertain |
| 3 | 18 | 15 | 8 | s1_r2_t3 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [32,34) | 0.056905 | 0.000976 | 0.000172 | 0.137500 | ir_dominant_risk |
| 4 | 20 | 16 | 7 | s1_r2_t2 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [31,32) | 0.013630 | 0.000273 | 0.000200 | 0.176000 | uncertain |
| 5 | 22 | 17 | 6 | s1_r2_t1 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [20,31) | 0.010112 | 0.000158 | 0.000156 | 0.176000 | ir_dominant_risk |
| 6 | 14 | 8 | 54 | s3_r3_t4 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [34,36) | 0.007990 | 0.004143 | 0.005185 | 0.244444 | uncertain |
| 7 | 24 | 17 | 55 | s3_r3_t5 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [36,60] | 0.004522 | 0.000000 | 0.000000 | 0.589286 | uncertain |
| 8 | 4 | -4 | 17 | s1_r4_t2 | SOC [0,10) / 倍率 [4.22,7.75] / 温度 [31,32) | 0.004344 | 0.019710 | 0.045370 | 0.000000 | dual_risk |
| 9 | 6 | -3 | 16 | s1_r4_t1 | SOC [0,10) / 倍率 [4.22,7.75] / 温度 [20,31) | 0.003564 | 0.013754 | 0.038595 | 0.080882 | dual_risk |
| 10 | 9 | -1 | 18 | s1_r4_t3 | SOC [0,10) / 倍率 [4.22,7.75] / 温度 [32,34) | 0.002128 | 0.011116 | 0.052247 | 0.068750 | cap_dominant_risk |
### 8.2 raw 与支持宽度归一排名对比（阻抗）
| rank_raw | rank_norm | rank_delta | cross_bin | cross_label | condition_text | effect_per_1pp | effect_support_norm | support_width_1_99 | q_value | risk_category |
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | 1 | 0 | 5 | s1_r1_t5 | SOC [0,10) / 倍率 [0,0.434) / 温度 [36,60] | 3.787507 | 0.040286 | 0.000106 | 0.000000 | dual_risk |
| 2 | 22 | 20 | 51 | s3_r3_t1 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [20,31) | 0.265315 | 0.000000 | 0.000000 | 0.303448 | uncertain |
| 3 | 15 | 12 | 8 | s1_r2_t3 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [32,34) | 0.090377 | 0.001550 | 0.000172 | 0.055000 | ir_dominant_risk |
| 4 | 18 | 14 | 7 | s1_r2_t2 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [31,32) | 0.024989 | 0.000500 | 0.000200 | 0.220000 | uncertain |
| 5 | 20 | 15 | 6 | s1_r2_t1 | SOC [0,10) / 倍率 [0.434,1.99) / 温度 [20,31) | 0.017809 | 0.000279 | 0.000156 | 0.161765 | ir_dominant_risk |
| 6 | 22 | 16 | 55 | s3_r3_t5 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [36,60] | 0.010172 | 0.000000 | 0.000000 | 0.372581 | uncertain |
| 7 | 13 | 6 | 54 | s3_r3_t4 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [34,36) | 0.009683 | 0.005021 | 0.005185 | 0.212500 | uncertain |
| 8 | 22 | 14 | 53 | s3_r3_t3 | SOC [90,100] / 倍率 [1.99,4.22) / 温度 [32,34) | 0.004871 | 0.000000 | 0.000000 | 0.864286 | uncertain |
| 9 | 5 | -4 | 16 | s1_r4_t1 | SOC [0,10) / 倍率 [4.22,7.75] / 温度 [20,31) | 0.004386 | 0.016929 | 0.038595 | 0.042308 | dual_risk |
| 10 | 21 | 11 | 3 | s1_r1_t3 | SOC [0,10) / 倍率 [0,0.434) / 温度 [32,34) | 0.004131 | 0.000048 | 0.000116 | 0.897642 | uncertain |
### 8.3 SOC×温度分层证据
| soc_bin | soc_label | temp_bin | temp_label | n_bins | cap_mean | cap_q_lt_0p1_share | cap_support_mean | ir_mean | ir_q_lt_0p1_share | ir_support_mean |
|---|---|---|---|---|---|---|---|---|---|---|
| 1 | [0,10) | 1 | [20,31) | 4 | 0.002148 | 0.250000 | 0.022171 | -0.012992 | 0.250000 | 0.022171 |
| 1 | [0,10) | 2 | [31,32) | 4 | -0.139067 | 0.500000 | 0.025034 | -0.170120 | 0.250000 | 0.025034 |
| 1 | [0,10) | 3 | [32,34) | 4 | -0.072357 | 0.500000 | 0.026265 | 0.023438 | 0.250000 | 0.026265 |
| 1 | [0,10) | 4 | [34,36) | 4 | -0.289516 | 0.250000 | 0.025536 | -0.231940 | 0.250000 | 0.025536 |
| 1 | [0,10) | 5 | [36,60] | 4 | 0.075543 | 0.750000 | 0.028335 | 0.734416 | 0.500000 | 0.028335 |
| 2 | [10,90) | 1 | [20,31) | 4 | 0.000618 | 0.250000 | 0.135770 | 0.000160 | 0.250000 | 0.135770 |
| 2 | [10,90) | 2 | [31,32) | 4 | 0.000357 | 0.500000 | 0.137970 | -0.000025 | 0.500000 | 0.137970 |
| 2 | [10,90) | 3 | [32,34) | 4 | 0.000630 | 0.500000 | 0.186594 | 0.000792 | 0.250000 | 0.186594 |
| 2 | [10,90) | 4 | [34,36) | 4 | -0.000129 | 0.500000 | 0.206466 | -0.000312 | 0.250000 | 0.206466 |
| 2 | [10,90) | 5 | [36,60] | 4 | -0.000904 | 0.500000 | 0.241257 | -0.001484 | 0.500000 | 0.241257 |
| 3 | [90,100] | 1 | [20,31) | 4 | 0.046894 | 0.000000 | 0.156302 | 0.088387 | 0.000000 | 0.156302 |
| 3 | [90,100] | 2 | [31,32) | 4 | -0.003996 | 0.000000 | 0.147674 | -0.007333 | 0.250000 | 0.147674 |
| 3 | [90,100] | 3 | [32,34) | 4 | -0.000826 | 0.000000 | 0.152880 | 0.001694 | 0.250000 | 0.152880 |
| 3 | [90,100] | 4 | [34,36) | 4 | 0.002504 | 0.000000 | 0.113540 | 0.003067 | 0.000000 | 0.113540 |
| 3 | [90,100] | 5 | [36,60] | 4 | 0.001611 | 0.000000 | 0.097309 | 0.003430 | 0.000000 | 0.097309 |
### 8.4 高温风险结论评估
| outcome | high_temp_bin | assessment | n_soc | positive_soc_count | top_soc_count | q_lt_0p1_soc_count | support_ok_soc_count | low_soc_label | low_soc_high_temp_mean | detail |
|---|---|---|---|---|---|---|---|---|---|---|
| capacity | 5 | partial | 3 | 2 | 1 | 2 | 2 | [0,10) | 0.075543 | positive_soc=2/3, top_soc=1/3, q<0.10_share_soc=2/3, support_ok_soc=2/3 |
| impedance | 5 | partial | 3 | 2 | 1 | 2 | 2 | [0,10) | 0.734416 | positive_soc=2/3, top_soc=1/3, q<0.10_share_soc=2/3, support_ok_soc=2/3 |
...
- X轴：温度物理区间（示例 `[20,31)`…`[36,60]`）。
- Y轴：倍率物理区间（示例 `[0,0.434)`…`[4.22,7.75]`）。
...
- `support_normalized_effects_compare.csv`
- `soc_temp_high_temp_evidence.csv`
- `high_temp_claim_assessment.csv`
